                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p><?php  echo $nama; ?></p>
                            <a href="#"><i class="fa fa-circle text-online"></i> Active</a>
         ...
         <li class="treeview">
               ...
               <ul class="treeview-menu">
                  ...
                  <li>
                     ...
                     <li>
                       <a href="surat_kelola"><i class="fa fa-circle-o"></i>Suket Barang Keluar</a>
                    </li>
...
if($chmenu1 >= 1 || $_SESSION['jabatan'] == 'admin'){ ?>
              ...
              <li class="treeview">
                            <a href=""> <i class="glyphicon glyphicon-cog"></i> <span>Pengelolaan User</span> <span class="pull-right-container"> </span> </a>
                               <ul class="treeview-menu">
                                <li>
