              ...
              <div class="box-body">
                ...
                <div class="row">
                        <div class="form-group col-md-6 col-xs-12" >
                          <label for="kode" class="col-sm-3 control-label">Nomor:</label>
                          <div class="col-sm-9">
                           <?php  if($no == null || $no ==""){ ?>
				...
				<div class="row">
				   <div class="form-group col-md-6 col-xs-12" >
                  <label for="nama" class="col-sm-3 control-label">Merek:</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $nama; ?>" placeholder="Nama Merk" maxlength="50">
                  </div>
                </div>
				</div>
