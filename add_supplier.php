...
if ($chmod >= 2 || $_SESSION['jabatan'] == 'admin') {
  ...
  <div id="main">
   <div class="container-fluid">
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  <label for="tgldaftar" class="col-sm-3 control-label">Terdaftar tanggal:</label>
                  <div class="col-sm-9">
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  <label for="nohp" class="col-sm-3 control-label">Kontak:</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="nohp" name="nohp" value="<?php echo $nohp; ?>" placeholder="Kontak Supplier" maxlength="50" required>
                  </div>
                </div>
        </div>
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  <label for="alamat" class="col-sm-3 control-label">Lokasi:</label>
                  <div class="col-sm-9">
                  <textarea class="form-control" rows="3" id="alamat" name="alamat" maxlength="255" placeholder="Lokasi" required><?php echo $alamat; ?></textarea>
                   </div>
                </div>
        </div>
