...
<div class="alert alert-danger alert-dismissible">
                ...
                Url Aplikasi belum disesuaikan dengan url app <br>
                         ...
                         <div class="col-lg-3 col-xs-6">
                           ...
                           <div class="small-box bg-aqua">
                               ...
                               <div class="icon">
                                 ...
                                 <a href="customer" class="small-box-footer">Info lengkap <i class="fa fa-arrow-circle-right"></i></a>
                           </div>
                       </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Url App</h4>
              </div>

                <form method="post" >
              <div class="modal-body">
                <p> Url Aplikasi Prohiv</p>

                

                 <div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label">Url Aplikasi</label>

                  <div class="col-sm-5">
                    <input type="text" class="form-control" name="url" placeholder="erp.amc.net.id">
                  </div>
                </div>
